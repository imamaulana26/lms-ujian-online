                        ...
                        <section class="pilihan-ganda">
                            <div class="card">
                                <div class="card-header d-flex">
                                    ...
                                    <div class="col-md-2">
                                        <select class="form-control" name="soal_tipe_pg">
                                ...
                                <div class="card-body">
                                    ...
                                    for ($i = 0; $i < count($n); $i++) { ?>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-4">
                                                <input type="text" class="form-control" name="lampiran_soal_<?= $n[$i] ?>" id="lampiran_soal_<?= $n[$i] ?>" placeholder="masukan URL dari Google Drive">
                                            </div>
                                            <div class="col-md-2">
                                                <select class="form-control" name="lampiran_tipe_<?= $n[$i] ?>">
                                                    <option value="" selected disabled>Pilih Type</option>
                                                    <option value="gambar">Gambar</option>
                                                    <option value="video">Video</option>
                                                    <option value="audio">Audio</option>
...
<script>
    $(document).ready(function() {
        ...
        $('#jns_soal').on('change', function() {
            ...
            $(".pilihan-ganda, .true-false, .jawaban-singkat, .multi-choices , .pilihan-ganda-kompleks").css('display', 'none');
