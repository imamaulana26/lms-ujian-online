                            ...
                            <div class="card">
                                <div class="card-header">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10">
                                            <label><?= $dt_program[0]['jns_program'] ?></label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10">
                                            <label><?= $dt_program[0]['nm_mapel'] ?></label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10">
                                            <label><?= $dt_program[0]['waktu_pengerjaan'] . ' Menit' ?></label>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-body">
                                    <label>Daftar Peserta Test</label>
                                    <form action="<?= site_url('manage_quis/save_peserta') ?>" method="post">
                                        ...
                                        <select class="select2" name="peserta[]" multiple="multiple" style="width: 100%; ">
                                            <?php foreach ($peserta as $key => $val) { ?>
                                                <option value="<?= $val['nis'] ?>" <?= $val['selected'] == 1 ? 'selected' : '' ?>><?= $val['nama'] ?></option>
                                            <?php }  ?>
                                        </select>
